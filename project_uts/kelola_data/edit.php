...
<html lang="en">
  <head>
    ...
    <title>DASHBOARD | EDIT DATA MAHASISWA</title>
      ...
      <div class="body-main">
        <form action="" method="POST">
          ...
          <div class="form-input">
            <input type="text" name="nama" id="nama" required="required" value="<?= $data['nama'] ?>" />
            <span>Name</span>
          </div>
          ...
          <div class="form-input">
            <input type="text" name="nim" id="nim" required="required" value="<?= $data['nim'] ?>" />
            <span>NIM</span>
          </div>
          <div class="form-input select-input">
